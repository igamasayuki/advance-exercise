...
<body>
	...
	<table border="1">
		...
		<c:forEach var="list" items="${list}">
			<tr>
				...
				<td><fmt:formatNumber  value="${list.price}" type="CURRENCY" currencySymbol="￥" groupingUsed="true" maxFractionDigits="0"/></td>
				<td>×</td>
				<td><c:out value="${list.quantity}" /></td>
				<td><fmt:formatNumber value="${list.price*list.quantity}" type="CURRENCY" currencySymbol="￥" groupingUsed="true" maxFractionDigits="0"/></td>
			</tr>
		</c:forEach>
	</table>
	<br>
	...
	<table border="1">
		...
		<tr>
			...
			<td><fmt:formatNumber  value="${total}" type="CURRENCY" currencySymbol="￥" groupingUsed="true" maxFractionDigits="0"/></td>
		</tr>
		<tr>
			<th>税</th>
			<td><fmt:formatNumber value="${total*0.08}" type="CURRENCY" currencySymbol="￥" groupingUsed="true" maxFractionDigits="0"/></td>
		</tr>
		<tr>
			<th>支払方法</th>
		...
		<tr>
			<th>送料一律</th>
			<td><fmt:formatNumber value="500" type="CURRENCY" currencySymbol="￥" groupingUsed="true" maxFractionDigits="0"/></td>
		</tr>
		<tr>
			<th>総計</th>
